package com.demo.petclinic.account.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.example.petclinic.account.controller"))
	...
	private ApiInfo apiEndPointsInfo() {
		return new ApiInfoBuilder().title("PetClinic Account Platform")
